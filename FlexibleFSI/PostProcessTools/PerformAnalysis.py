...
sheetN = 2; # sheet2 (numbering of sheets from 0)
pointN = 12; # control point 12 from sheet2 (numbering of cpoints from 0)
...
myLib.normalMode_frequency_plot( sheetN, pointN, mode=1, stretchRatio=0.15, align="y" )

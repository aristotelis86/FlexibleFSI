...
def normalMode_frequency_plot( sheetN, pointN, mode, stretchRatio ):
...
def impulse_frequency_analysis( sheetN, pointN, newL, g=10 ):
...
def sort_them( ind, fr, sp ):
    # Custom sorting of the peaks. Getting the first 3.
    myfr = fr[ind];
    mysp = sp[ind];
#    ind = np.argsort(mysp);
    print(mysp);
